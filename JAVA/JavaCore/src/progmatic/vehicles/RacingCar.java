...
public class RacingCar extends Vehicle {
    ...
    public RacingCar(String manufacturer, String type, String color, int numberOfPassengers,
                     boolean isSelfDriving, boolean hasCrossBracing, boolean extinguishingSystem) {
